...
checkpoint_path=/path/NARVL/nat_ofa_huge_snli_ve_pretrained_3/checkpoint_6_10500.pt
result_path=/path/NARVL/nat_ofa_huge_snli_ve_pretrained_3/results/
