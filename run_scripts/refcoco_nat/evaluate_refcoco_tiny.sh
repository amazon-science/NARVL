...
data=refcoco_val.tsv
#checkpoint_path=/path/NARVL/nat_ofa_tiny_refcoco_5/checkpoint_last.pt
model_root=/path/NARVL/nat_ofa_tiny_refcoco_5
checkpoint_path=${model_root}/checkpoint_best.pt

#checkpoint_path=/path/NARVL/nat_ofa_tiny_refcoco_5_resumed/checkpoint_last.pt
#save_path=/path/NARVL/nat_ofa_tiny_refcoco_5_resumed
result_path=${model_root}/result
...
#model_root=/path/NARVL/nat_ofa_tiny_refcocoplus_5
...
#
########################### Evaluate Refcocog ##########################
#model_root=/path/NARVL/nat_ofa_tiny_refcocog_5
##checkpoint_path=${model_root}/checkpoint_last.pt
#checkpoint_path=${model_root}/checkpoint_best.pt
#save_path=${model_root}/results
##
