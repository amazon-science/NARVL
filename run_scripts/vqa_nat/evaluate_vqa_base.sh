...
checkpoint_path=/path/NARVL/nat_ofa_vqa_6_distill_from_base_resumed8/checkpoint1.pt
result_path=/path/NARVL/nat_ofa_vqa_6_distill_from_base_resumed8/results_beam
