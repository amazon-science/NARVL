...
class Dictionary:
    ...
    def string(
        ...
        extra_symbols_to_ignore = list(extra_symbols_to_ignore or [])
        extra_symbols_to_ignore = set(extra_symbols_to_ignore + self.ignore_symbols)
        if not include_eos:
    ...
    def add_symbol(self, word, n=1, overwrite=False, ignore_in_string=False):
        ...
        if ignore_in_string:
            self.ignore_symbols.append(idx)
        return idx
