...
GPUS_PER_NODE=8
#save_path=/path/NARVL/nat_ofa_tiny_refcoco_5
save_path=/path/NARVL/nat_ofa_tiny_refcoco_5_tmp
...
#data=${data_dir}/refcoco_train_tiny.tsv,${data_dir}/refcoco_train_tiny.tsv
data=${data_dir}/refcoco_train.tsv,${data_dir}/refcoco_val.tsv
selected_cols=0,4,2,3
restore_file=/path/downloaded_checkpoints/ofa_tiny.pt
