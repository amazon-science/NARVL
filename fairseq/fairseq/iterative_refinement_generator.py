...
class IterativeRefinementGenerator(object):
    def __init__(
        ...
        self.collapse_repetition = collapse_repetition
    ...
    def generate(self, models, sample, prefix_tokens=None, constraints=None):
        ...
        if self.beam_size > 1:
            ...
            prev_decoder_out = model.regenerate_length_beam(prev_decoder_out, self.beam_size, encoder_out)
        ...
        for step in range(self.max_iter + 1):
            ...
            if self.collapse_repetition:
                from fairseq.models.nat.levenshtein_utils import _collapse
                _collapse(decoder_out.output_tokens, decoder_out.output_scores, self.pad)
