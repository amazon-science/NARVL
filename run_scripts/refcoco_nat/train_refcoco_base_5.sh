...
GPUS_PER_NODE=8
#save_path=/path/NARVL/nat_ofa_refcoco_pretrained_5_10epoch_bsreduced
save_path=/path/NARVL/nat_ofa_refcoco_base_seed2
mkdir -p save_path
...
#restore_file=/path/NARVL/nat_ofa_refcoco/checkpoint_last.pt
