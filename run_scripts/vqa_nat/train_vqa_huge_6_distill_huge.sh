...
#data=${data_dir}/vqa_train_1_tiny.tsv,${data_dir}/vqa_val.tsv
# Note: If you have shuffled the data in advance, please uncomment the line below.
data=${data_dir}/vqa_train_distill_huge_1.tsv,${data_dir}/vqa_train_distill_huge_2.tsv,${data_dir}/vqa_train_distill_huge_3.tsv,${data_dir}/vqa_train_distill_huge_4.tsv,${data_dir}/vqa_train_distill_huge_5.tsv,${data_dir}/vqa_train_distill_huge_6.tsv,${data_dir}/vqa_train_distill_huge_7.tsv,${data_dir}/vqa_train_distill_huge_8.tsv,${data_dir}/vqa_train_distill_huge_9.tsv,${data_dir}/vqa_train_distill_huge_10.tsv,${data_dir}/vqa_val.tsv
ans2label_file=/path/vqa_data/trainval_ans2label.pkl
selected_cols=0,5,2,3,4

save_path=/path/NARVL/nat_ofa_huge_vqa_6_distill_from_huge
mkdir -p save_path
